...
/**
 * Abstract WPT_WP_Background_Process class.
 *
 * @abstract
 * @extends WPT_WP_Async_Request
 */
abstract class WPT_WP_Background_Process extends WPT_WP_Async_Request {
	 ...
	 *
	 * @param bool|array $allowed_batch_data_classes Optional. Array of class WPT_names that can be unserialized. Default true (any class).
	 */
	 ...
	 * @param bool|array $allowed_classes Array of class WPT_names that can be unserialized.
	 *
	 * @return mixed
	 */
